                  ...
                  <div className="w-[318px] rounded-[10px] bg-[#EDD5FF] px-4 py-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="h-[18.13px] px-3 rounded-full border border-black flex items-center justify-center -mt-2">
                          <span className="text-[10.43px] leading-[1] text-[#000]">
                            D-1
                          </span>
                        </div>
                        <span className="text-[11.47px] leading-[1] text-[#000] -mt-2">
                          25.08.11 (월) 18:00
                        </span>
                      </div>
                      <div className="rounded-[10px] bg-[#9810FA] text-white text-[15px] leading-[1.193] px-[10px] py-[10px] mt-2">
                        제출하기
                      </div>
                    </div>
          ...
          <Card className="shadow-md border border-[#E4E4E4] rounded-[10px] w-full mt-2 py-4">
            <CardContent className="px-3 py-0">
              <div className="flex items-center justify-between">
                ...
                <button className="text-[12px] leading-[1.19] text-[#4E4D4D] underline">
                  상세보기
                </button>
              </div>
