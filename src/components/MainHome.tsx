...
export function MainHome() {
  ...
  useEffect(() => {
    ...
    const handleSelect = () => setCarouselIndex(carouselApi.selectedScrollSnap());
    handleSelect();
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="h-[18.13px] px-3 rounded-full border border-black flex items-center justify-center">
                        <span className="text-[10.43px] leading-[1] text-[#000]">D-1</span>
                      </div>
                      <span className="text-[11.47px] leading-[1] text-[#000]">25.08.11 (월) 18:00</span>
                    </div>
                    <div className="rounded-[10px] bg-[#9810FA] text-white text-[15px] leading-[1.193] px-[10px] py-[10px]">
                      제출하기
                    </div>
                  </div>
                  <div className="mt-2 text-[14.6px] leading-[1] text-[#000]">뭐시기 뭐뭐 시험 제출</div>
                </div>
              </CarouselItem>
            ))}
          </CarouselContent>
      ...
      <section className="space-y-0">
        ...
        <Card className="shadow-md border border-[#E4E4E4] rounded-[10px] w-full mt-2 py-4">
          <CardContent className="px-3 py-0">
            ...
            {/* 정답률 라벨 */}
            <div className="mt-3 text-[10.43px] leading-[1] text-[#000]">정답률(%)</div>
            ...
            <div className="w-full mt-1 relative" style={{ height: 160 }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData} margin={{ top: 8, right: 8, left: 8, bottom: 0 }}>
                  ...
                  <XAxis dataKey="name" tick={{ fontSize: 10 }} interval={0} height={26} />
              ...
              <div className="absolute right-0 top-0 flex flex-col items-end gap-2 pr-2 pt-1">
                <div className="flex items-center gap-2">
                  <div style={{ width: 7.8, height: 7.8, backgroundColor: '#9810FA', borderRadius: 2 }} />
                  <span className="text-[10.43px] leading-[1] text-[#000]">우수</span>
                </div>
                <div className="flex items-center gap-2">
                  <div style={{ width: 7.8, height: 7.8, backgroundColor: '#D499FF', borderRadius: 2 }} />
                  <span className="text-[10.43px] leading-[1] text-[#000]">보통</span>
                </div>
                <div className="flex items-center gap-2">
                  <div style={{ width: 7.8, height: 7.8, backgroundColor: '#EDD5FF', borderRadius: 2 }} />
                  <span className="text-[10.43px] leading-[1] text-[#000]">노력 필요</span>
                </div>
              </div>
            </div>
                ...
                <div key={idx}>
                  <div className="flex items-start justify-between py-1.5">
                    <div className="flex flex-col gap-0.5">
                      <span className="text-[13px] font-bold leading-[1.19] text-[#000]">가다나 시험 4번</span>
                      <span className="text-[13px] leading-[1.19] text-[#427BFF]"># 1. 식의 계산 - 다항식의 곱셈</span>
                      <div className="flex items-center gap-3">
                        <span className="text-[11px] leading-[1.19] text-[#000]">유형 : 계산</span>
                        <span className="text-[11px] leading-[1.19] text-[#000]">난이도 : 중</span>
                      </div>
                    </div>
                    <ChevronRight className="h-11 w-5 text-[#1C1C1E]" />
                  </div>
                  {idx < arr.length - 1 && <div className="h-px w-full bg-[#E4E4E4]" />}
                </div>
              ))}
            </div>
          </CardContent>
