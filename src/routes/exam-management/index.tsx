...
export function ExamManagementPage() {
  ...
  const [selectedWrongNote, setSelectedWrongNote] = useState<number | null>(
    null,
  );
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-4">
                      <span className="text-[13px] font-bold text-black leading-[1.193]">
                        {problem.number}
                      </span>
                      <span className="text-[13px] text-[#427BFF] leading-[1.193]">
                        {problem.topic}
                      </span>
                    </div>
