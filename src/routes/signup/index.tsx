    ...
    <div className={cn("w-full h-screen overflow-hidden flex justify-center")}> 
      ...
      > 
        ...
        <div className="space-y-2">
          ...
          <Input id="username" placeholder="아이디를 입력해주세요" className="h-[50px] rounded-lg" />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input id="name" placeholder="이름을 입력해주세요" className="h-[50px] rounded-lg" />
        </div>

        {/* 학교 */}
        <div className="space-y-2">
          <Label htmlFor="school">학교</Label>
          <Input id="school" placeholder="학교를 입력해주세요" className="h-[50px] rounded-lg" />
        </div>
        ...
        <div className="grid grid-cols-[166px_142px] gap-3">
          <div className="space-y-2">
            ...
            <Select defaultValue="middle">
              <SelectTrigger id="schoolLevel" className="!h-[50px] rounded-lg w-[166px]">
          ...
          <div className="space-y-2">
            <Label htmlFor="gradeYear" className="invisible">학년</Label>
            <Select defaultValue="1">
              <SelectTrigger id="gradeYear" className="!h-[50px] rounded-lg w-[142px]">
        ...
        <div className="space-y-2">
          ...
          <Input id="phone" type="tel" placeholder="전화번호를 입력해주세요" className="h-[50px] rounded-lg" />
        </div>
        </div>

        {/* 제출 버튼 */}
        <Button asChild className="w-full h-12 text-base bg-violet-700 hover:bg-violet-700/90">
          <Link to="/">회원가입</Link>
        </Button>
      </div>
    </div>
